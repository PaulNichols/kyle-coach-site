...
const OneOnOne: React.FC = () => {
  ...
  return (
    <section id="one-on-one" className="py-20 sm:py-28 bg-zinc-950">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-3xl font-semibold mb-4 text-zinc-100">Personalized Basketball Development</h3>
            <p className="mb-6 text-zinc-300 leading-relaxed">
              Individual coaching sessions tailored to each player's unique needs and goals. Whether you're a beginner learning fundamentals or an advanced player refining technique, one-on-one sessions deliver results.
            </p>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-10 text-left">
          {steps.map((step, index) => (
            <div key={index} className="relative pt-8 border-t-2 border-zinc-700">
               <span className="absolute top-0 left-0 -mt-4 bg-zinc-950 px-2 font-serif text-2xl text-amber-400">
                0{index + 1}
              </span>
